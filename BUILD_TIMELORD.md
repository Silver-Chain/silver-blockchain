...
required to run a [Timelord](https://github.com/Chia-Network/silver-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Chia-Network/silver-blockchain/blob/main/install-timelord.sh)
