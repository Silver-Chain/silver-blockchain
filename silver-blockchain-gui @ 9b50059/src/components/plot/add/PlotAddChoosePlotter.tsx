...
import { CardStep, Select } from '@silver/core';
import {
  FormControl,
  FormHelperText,
  Grid,
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Silver Proof of Space plotter. If unsure,
            use the default Silver Proof of Space plotter.
        </Trans>
      </Typography>
