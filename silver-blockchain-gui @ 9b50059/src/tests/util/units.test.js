...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of silver', () => {
      const result = units.getUnit('silver');
    ...
    it('gets unit of silver using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of silver', () => {
      const result = units.getDisplay('silver');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('silver', 9);

      const result = units.getUnit('silver');

      expect(result).toEqual(9);

      units.setUnit('silver', 1);
    });
  });
  describe('#setDisplay', () => {
