...
rm -rf ../venv || true
rm -rf venv || true
rm -rf silver_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf silver-blockchain-gui/build || true
rm -rf silver-blockchain-gui/daemon || true
rm -rf silver-blockchain-gui/node_modules || true
rm silver-blockchain-gui/temp.json || true
( cd "$PWD/silver-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
