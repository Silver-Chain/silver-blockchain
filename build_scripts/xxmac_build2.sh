...
# echo "Sign ========================================================================"
# electron-osx-sign silver-darwin-x64/silver.app --platform=darwin \
...
# notarize-cli --file=$DMG_NAME.dmg --bundle-id net.silver.blockchain --username "email@gmail.com" --password ""
