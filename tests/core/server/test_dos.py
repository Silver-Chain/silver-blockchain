...
from silver.protocols.shared_protocol import Handshake
from silver.server.outbound_message import make_msg, Message
from silver.server.rate_limits import RateLimiter
from silver.server.server import ssl_context_for_client
...
class TestDos:
    ...
    async def test_large_message_disconnect_and_ban(self, setup_two_nodes):
        ...
        ssl_context = ssl_context_for_client(
            server_2.silver_ca_crt_path, server_2.silver_ca_key_path, server_2.p2p_crt_path, server_2.p2p_key_path
        )
    ...
    async def test_spam_tx(self, setup_two_nodes):
        ...
        ws_con: WSSilverConnection = list(server_1.all_connections.values())[0]
        ws_con_2: WSSilverConnection = list(server_2.all_connections.values())[0]
