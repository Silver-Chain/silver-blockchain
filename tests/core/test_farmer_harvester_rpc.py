...
from silver.plotting.util import stream_plot_info_ph, stream_plot_info_pk, PlotRefreshResult, PlotRefreshEvents
from silver.plotting.manager import PlotManager
from silver.protocols import farmer_protocol
from silver.rpc.farmer_rpc_api import FarmerRpcApi
from silver.rpc.farmer_rpc_client import FarmerRpcClient
from silver.rpc.harvester_rpc_api import HarvesterRpcApi
from silver.rpc.harvester_rpc_client import HarvesterRpcClient
...
from silver.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "slv"), encode_puzzle_hash(new_ph_2, "slv"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "slv"))
            ...
            assert config["farmer"]["slv_target_address"] == encode_puzzle_hash(new_ph, "slv")
            assert config["pool"]["slv_target_address"] == encode_puzzle_hash(new_ph_3, "slv")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "slv")
