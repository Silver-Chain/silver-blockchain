...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "xcf"), encode_puzzle_hash(new_ph_2, "xcf"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "xcf"))
            ...
            assert config["farmer"]["xcf_target_address"] == encode_puzzle_hash(new_ph, "xcf")
            assert config["pool"]["xcf_target_address"] == encode_puzzle_hash(new_ph_3, "xcf")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "xcf")
