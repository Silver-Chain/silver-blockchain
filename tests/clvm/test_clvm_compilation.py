...
wallet_program_files = set(
    [
        "silver/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "silver/wallet/puzzles/cc.clvm",
        "silver/wallet/puzzles/chialisp_deserialisation.clvm",
        "silver/wallet/puzzles/rom_bootstrap_generator.clvm",
        "silver/wallet/puzzles/generator_for_single_coin.clvm",
        "silver/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "silver/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "silver/wallet/puzzles/lock.inner.puzzle.clvm",
        "silver/wallet/puzzles/p2_conditions.clvm",
        "silver/wallet/puzzles/p2_delegated_conditions.clvm",
        "silver/wallet/puzzles/p2_delegated_puzzle.clvm",
        "silver/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "silver/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "silver/wallet/puzzles/p2_puzzle_hash.clvm",
        "silver/wallet/puzzles/rl_aggregation.clvm",
        "silver/wallet/puzzles/rl.clvm",
        "silver/wallet/puzzles/sha256tree_module.clvm",
        "silver/wallet/puzzles/singleton_top_layer.clvm",
        "silver/wallet/puzzles/did_innerpuz.clvm",
        "silver/wallet/puzzles/decompress_puzzle.clvm",
        "silver/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "silver/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "silver/wallet/puzzles/block_program_zero.clvm",
        "silver/wallet/puzzles/test_generator_deserialize.clvm",
        "silver/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "silver/wallet/puzzles/p2_singleton.clvm",
        "silver/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "silver/wallet/puzzles/pool_member_innerpuz.clvm",
        "silver/wallet/puzzles/singleton_launcher.clvm",
        "silver/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["silver/wallet/puzzles/create-lock-puzzlehash.clvm", "silver/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "silver/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to silver/wallet/puzzles, but not added to `wallet_program_files`
        """
