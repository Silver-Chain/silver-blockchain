...
from silver.wallet.puzzles.p2_conditions import puzzle_for_conditions
from silver.wallet.puzzles import singleton_top_layer
from silver.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - silver.pools.pool_puzzles.py
    - silver.wallet.puzzles.pool_member_innerpuz.clvm
    - silver.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
...
class TestPoolPuzzles(TestCase):
    def test_pool_lifecycle(self):
        ...
        GENESIS_CHALLENGE = bytes32.fromhex("6983a18828b9ffc469152643958f9656912fff6db75fc46a2134d7154af84b5b")
