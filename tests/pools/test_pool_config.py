...
from silver.pools.pool_config import PoolWalletConfig
from silver.util.config import load_config, save_config, create_default_silver_config
...
def test_pool_config():
    ...
    create_default_silver_config(test_root, ["config.yaml"])
