...
from silver.util.ints import int8, uint8, int16, uint16, int32, uint32, int64, uint64, uint128, int512
...
class TestStructStream:
    ...
    def test_int512(self):
        # int512 is special. it uses 65 bytes to allow poSLVive and negative
        # "uint512"
        self._test_impl(
            int512,
