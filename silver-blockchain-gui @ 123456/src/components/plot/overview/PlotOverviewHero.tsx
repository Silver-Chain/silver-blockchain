...
import { CardHero, Flex, Link } from '@silver/core';
import { PlotHero as PlotHeroIcon } from '@silver/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Silver. '
              }
              <Link
                target="_blank"
                href="https://github.com/silver-network/silver-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
