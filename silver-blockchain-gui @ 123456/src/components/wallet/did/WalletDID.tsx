...
import { AlertDialog, Card, Flex, Loading, Dropzone } from '@silver/core';
import {
...
import { mojo_to_silver_string } from '../../../util/silver';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_silver_string(props.balance)} TSLV
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const CreateAttest = (props) => {
  ...
  function createAttestPacket() {
    ...
    if (address.substring(0, 12) === 'silver_addr://') {
...
const CashoutCard = (props) => {
  ...
  function cashout() {
    ...
    if (puzzlehash.slice(0, 12) === 'silver_addr://') {
