...
import { /* mojo_to_silver_string, */ silver_to_mojo } from '../../../util/silver';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_silver_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of silver in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Silver that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Silver that you have just spent but is not
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      openDialog(
        <AlertDialog>
          <Trans>
            Error: Cannot send silver to coloured address. Please enter a silver
            address.
          </Trans>
        </AlertDialog>,
      );
    ...
    if (address.slice(0, 12) === 'silver_addr://') {
    ...
    const amountValue = Number.parseFloat(silver_to_mojo(amount));
    const feeValue = Number.parseFloat(silver_to_mojo(fee));
