...
import { Flex, Form, InputBase, Loading } from '@silver/core';
...
import { silver_to_mojo, mojo_to_silver } from '../../util/silver';
...
export default function StakeMain() {
    ...
    async function handleWithdraw(values: FormData) {
      ...
      const inputValue = Number.parseFloat(silver_to_mojo(inputAmount));
    ...
    return (
        <Flex flexDirection="column" gap={3}>
          ...
          Please select your staking address and send SLV to it.
          </Typography>
