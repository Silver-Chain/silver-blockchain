...
````bash
~/.silver/<currentversion>/config/ssl/daemon/private_daemon.crt
~/.silver/<currentversion>/config/ssl/daemon/private_daemon.key
````
...
````bash
~/.silver/<currentversion>/config/ssl/ui/
~/.silver/<currentversion>/config/ssl/ui/
````
