...
testnet_kwargs = {
    ...
    "GENESIS_CHALLENGE": bytes.fromhex("fc81443baeeb3558595153c8fdb6bad95107195389b36b191675d0f88abadb96"),
    # Forks of silver should change this value to provide replay attack protection. This is set to mainnet genesis chall
