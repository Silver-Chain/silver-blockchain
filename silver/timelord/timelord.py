...
from silver.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from silver.timelord.iters_from_block import iters_from_block
from silver.timelord.timelord_state import LastState
from silver.timelord.types import Chain, IterationType, StateType
from silver.types.blockchain_format.classgroup import ClassgroupElement
from silver.types.blockchain_format.reward_chain_block import RewardChainBlock
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[SilverServer] = None
    ...
    async def _handle_failures(self):
        ...
        # If something goes wrong in the VDF client due to a failed thread, we might get stuck in a SLVuation where we
