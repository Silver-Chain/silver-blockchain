...
from silver import __version__
from silver.consensus.block_record import BlockRecord
from silver.consensus.coinbase import create_puzzlehash_for_pk, farmer_parent_id, pool_parent_id
from silver.consensus.constants import ConsensusConstants
from silver.consensus.find_fork_point import find_fork_point_in_chain
from silver.full_node.weight_proof import WeightProofHandler
from silver.pools.pool_puzzles import SINGLETON_LAUNCHER_HASH, solution_to_pool_state
from silver.pools.pool_wallet import PoolWallet
from silver.protocols.wallet_protocol import PuzzleSolutionResponse, RespondPuzzleSolution
from silver.server.server import SilverServer
from silver.types.blockchain_format.coin import Coin
from silver.types.blockchain_format.program import Program
from silver.types.blockchain_format.sized_bytes import bytes32
from silver.types.coin_spend import CoinSpend
...
from silver.util.byte_types import hexstr_to_bytes
from silver.util.db_wrapper import DBWrapper
from silver.util.errors import Err
from silver.util.hash import std_hash
from silver.util.ints import uint32, uint64, uint128
from silver.util.db_synchronous import db_synchronous_on
from silver.wallet.block_record import HeaderBlockRecord
from silver.wallet.cc_wallet.cc_wallet import CCWallet
from silver.wallet.derivation_record import DerivationRecord
from silver.wallet.derive_keys import master_sk_to_backup_sk, master_sk_to_farmer_sk, master_sk_to_wallet_sk
from silver.wallet.did_wallet.did_wallet import DIDWallet
from silver.wallet.key_val_store import KeyValStore
from silver.wallet.rl_wallet.rl_wallet import RLWallet
from silver.wallet.settings.user_settings import UserSettings
from silver.wallet.trade_manager import TradeManager
from silver.wallet.transaction_record import TransactionRecord
from silver.wallet.util.backup_utils import open_backup_file
from silver.wallet.util.transaction_type import TransactionType
from silver.wallet.util.wallet_types import WalletType
from silver.wallet.wallet import Wallet
from silver.wallet.wallet_action import WalletAction
from silver.wallet.wallet_action_store import WalletActionStore
from silver.wallet.wallet_block_store import WalletBlockStore
from silver.wallet.wallet_blockchain import WalletBlockchain
from silver.wallet.wallet_coin_record import WalletCoinRecord
from silver.wallet.wallet_coin_store import WalletCoinStore
from silver.wallet.wallet_info import WalletInfo, WalletInfoBackup
from silver.wallet.wallet_interested_store import WalletInterestedStore
from silver.wallet.wallet_pool_store import WalletPoolStore
from silver.wallet.wallet_puzzle_store import WalletPuzzleStore
from silver.wallet.wallet_sync_store import WalletSyncStore
from silver.wallet.wallet_transaction_store import WalletTransactionStore
from silver.wallet.wallet_user_store import WalletUserStore
...
class WalletStateManager:
        ...
        if len(additional_coin_spends) > 0:
            ...
            for wallet_id, wallet in self.wallets.items():
                if wallet.type() == WalletType.POOLING_WALLET:
                    await wallet.apply_state_tranSLVions(additional_coin_spends, height)
    ...
    async def get_filter_additions_removals(
        ...
        """Returns a list of our coin ids, and a list of puzzle_hashes that poSLVively match with provided filter."""
