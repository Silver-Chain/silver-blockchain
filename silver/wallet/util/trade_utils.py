...
from silver.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "silver" in cc_discrepancies:
                    cc_discrepancies["silver"] = cc_discrepancies["silver"] + diff
                else:
                    cc_discrepancies["silver"] = diff
