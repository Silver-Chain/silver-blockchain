...
from silver.wallet.puzzles.puzzle_utils import (
...
from silver.wallet.secret_key_store import SecretKeyStore
from silver.wallet.sign_coin_spends import sign_coin_spends
...
class Wallet:
    ...
    async def create_spend_bundle_relative_silver(self, silver_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if silver_amount < 0:
            utxos = await self.select_coins(abs(silver_amount), exclude)
        else:
        ...
        silver_amount = spend_value + silver_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": silver_amount}]
