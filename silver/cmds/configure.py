...
from silver.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "53844"
            testnet_introducer = "introducer-testnet.farming.silver"
            testnet_dns_introducer = "dns-introducer-testnet.farming.silver"
            testnet = "testnet7"
            ...
            mainnet_port = "33844"
            mainnet_introducer = "introducer.farming.silver"
            mainnet_dns_introducer = "dns-introducer.farming.silver"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running silver services for changes to take effect")
