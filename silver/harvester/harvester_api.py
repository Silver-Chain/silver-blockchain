...
from silver.harvester.harvester import Harvester
from silver.plotting.util import PlotInfo, parse_plot_info
from silver.protocols import harvester_protocol
from silver.protocols.farmer_protocol import FarmingInfo
from silver.protocols.harvester_protocol import Plot
from silver.protocols.protocol_message_types import ProtocolMessageTypes
from silver.server.outbound_message import make_msg
...
from silver.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSSilverConnection
    ):
        """
