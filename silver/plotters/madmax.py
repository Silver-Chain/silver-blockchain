...
from silver.plotting.create_plots import resolve_plot_keys
from silver.plotters.plotters_util import run_plotter, run_command
...
def install_madmax(plotters_root_path: Path):
    if is_madmax_supported():
        ...
        run_command(
            ...
            "Could not clone madmax git repoSLVory",
...
def plot_madmax(args, silver_root_path: Path, plotters_root_path: Path):
