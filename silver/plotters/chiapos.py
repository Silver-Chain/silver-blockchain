"""
NOTE: This contains duplicate code from `silver.cmds.plots`.
After `silver plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Silver Proof of Space", "version": chiapos_version, "installed": True}
...
def plot_silver(args, root_path):
