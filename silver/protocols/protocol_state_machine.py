from silver.protocols.protocol_message_types import ProtocolMessageTypes as pmt, ProtocolMessageTypes
...
VAILD_REPLY_MESSAGE_MAP = {
    ...
    # pmt.handshake is handled in WSSilverConnection.perform_handshake
